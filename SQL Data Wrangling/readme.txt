Data wrangling and analysis for an imaginary online store.
Written by Mohsen Soliman, using MySQL workbench.

I wrote this sql file to practice and apply the techniques I've learned form:
...
Task 9: Count the number of users deleted each day. Then count the number of users removed due to merging in a similar way.
